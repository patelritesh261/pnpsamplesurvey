...
//sends mail to the given it and redirects it to user page
...
// user response to the survey and is stored in respond schema 
router.post('/presend', (req: express.Request, res: express.Response, next: any) => {
...
//gets the user name and info from hyper link and then send them to feedback page
...
// feedback from the user of mcq template for user
...
// gets feedbak from agree and disagree template for user
...
// get the feedback from any person
